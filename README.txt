Description
===========
Example project to demonstrate content sharing

Scenario:
The news list page shows all news articles from the common folder.
http://localhost:8080/site/news
http://localhost:8080/site/b2b/news
If a channel has an overridden version of the document in the channel folder that document is shown.

A custom link processor is (org.example.linkprocessor.NewsPagesLinkProcessor) makes this possible.
